Consider two *n*-element arrays of integers, *A = [a0, a1, ... ,an-1]* and *B = [b0, b1, ... ,bn-1]*. You want to permute them into some *A'* and *B'* such that the relation *a'i + b'i ≥ k* holds for all *i* where 0 ≤ *i* < *n*.
